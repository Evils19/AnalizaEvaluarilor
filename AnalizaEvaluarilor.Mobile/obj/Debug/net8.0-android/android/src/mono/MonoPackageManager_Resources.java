...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AnalizaEvaluarilor.Mobile.dll" comes first in this list. */
		"AnalizaEvaluarilor.Mobile.dll",
		"DocaLabs.Http.Client.dll",
		"DocaLabs.Http.Client.Extension.NewtonSoft.dll",
		"GoogleGson.dll",
